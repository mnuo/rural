...
<link rel="stylesheet" href="${path }/static/style/common.css">
<link rel="stylesheet" href="${path }/static/style/login.css">
...
<script type="text/javascript" src="${path }/static/libs/MD5.js"></script>
