...
<%@ include file="/commons/itemheader.jsp" %>
        ...
        parent.$.modalDialog({
            ...
            buttons : [ {
                ...
                handler : function() {
                    ...
                    parent.$.modalDialog.openner_treeGrid = organizationTree;
    ...
    function editUserFun(id) {
        ...
        parent.$.modalDialog({
            ...
            buttons : [ {
                ...
                handler : function() {
                    parent.$.modalDialog.openner_dataGrid = userDataGrid;//因为添加成功之后，需要刷新这个dataGrid，所以先预定义好
                    parent.$.modalDialog.openner_treeGrid = organizationTree;//因为添加成功之后，需要刷新这个dataGrid，所以先预定义好
