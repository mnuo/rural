...
<%-- [my97日期时间控件] --%>
<script type="text/javascript" src="${staticPath }/static/libs/My97DatePicker/WdatePicker.js" charset="utf-8"></script>
<%-- [jQuery] --%>
<script type="text/javascript" src="${staticPath }/static/libs/easyui/jquery.min.js" charset="utf-8"></script>
<%-- [EasyUI] --%>
